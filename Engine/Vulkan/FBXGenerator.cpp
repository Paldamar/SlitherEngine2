...
VulkanFBXGenerator::VulkanFBXGenerator()
...
void VulkanFBXGenerator::Begin(ID3D12Device * device, ID3D12GraphicsCommandList * cmdList, ID3D12DescriptorHeap* cbvHeap)
{
	if (mInBeginEndPair)
...
void VulkanFBXGenerator::LoadFBXStaticGeometry(
...
void VulkanFBXGenerator::BuildFBXGeometry(const std::vector<Vertex>& outVertices,
...
void VulkanFBXGenerator::BuildFBXTexture(
	std::vector<Material>& outMaterial,
