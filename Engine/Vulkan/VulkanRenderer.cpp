...
{
	auto vertShaderCode = ReadFile("Assets/Shaders/SPIR-V/vert.spv");
	auto fragShaderCode = ReadFile("Assets/Shaders/SPIR-V/frag.spv");
...
void VulkanRenderer::UpdateUniformBuffer(uint32_t currentImage)
{
	...
	MyMatrix mat;
	mat.CreateSRT(vec3(1.0f), vec3(0.0f), vec3(0.0f));
	mat.Rotate(time * 90.0f, 0.0f, 1.0f, 0.0f);
	ubo.model = mat;
